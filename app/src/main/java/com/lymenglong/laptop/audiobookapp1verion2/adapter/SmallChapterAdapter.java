...
import com.lymenglong.laptop.audiobookapp1verion2.ListALLChapter;
import com.lymenglong.laptop.audiobookapp1verion2.ListSmallChapter;
...
public class SmallChapterAdapter extends RecyclerView.Adapter {
    private ArrayList<SmallChapter> chapters;
    private Activity activity;
    private View view;

    public SmallChapterAdapter(Activity activity, ArrayList<SmallChapter> chapters) {
    ...
    class ChapterHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if(view == itemView) {
                Intent intent = new Intent(activity, ListALLChapter.class);
